...
The skill is a client for the remote paper-trading API. User bindings, SMS sessions, innerCode cache, and audit logs are stored by the server, not inside this workspace.

## Environment variables

Required when the API enables token auth:
