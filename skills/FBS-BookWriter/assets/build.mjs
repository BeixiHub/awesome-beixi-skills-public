...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 800" width="600" height="800">
  ...
  <text x="300" y="700" text-anchor="middle" fill="#ffffff66" font-size="12"
        font-family="Source Han Sans SC,Microsoft YaHei,sans-serif">Powered by 福帮手AI协同平台</text>
</svg>`;
}
...
<div class="copyright-page">
  ...
  <p>本书在资料整理、数据分析和初稿生成过程中使用了福帮手AI协同平台。<br>
     所有内容均经过福帮手AI审核、事实核查和独立判断。最终文责由作者承担。</p>
  <p>版本：${dateStr()}</p>
  <p>Powered by 福帮手AI协同平台</p>
</div>`;
}
...
async function main() {
  console.log('═══════════════════════════════════════');
  console.log(' FBS-BookWriter 构建系统 v2');
  console.log(' Powered by 福帮手AI协同平台');
  console.log('═══════════════════════════════════════');
